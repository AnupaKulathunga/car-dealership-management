...
\hline
\rowcolor{TableAlt}
\textbf{Total Story Points Planned} & 21 points \\
\hline
\textbf{Total Story Points Completed} & 21 points \\
\hline
\rowcolor{TableAlt}
\textbf{Sprint Velocity}   & 21 points / sprint \\
\hline
\end{tabularx}
...
The following user stories were selected for Sprint~2 during the Sprint Planning ceremony:
